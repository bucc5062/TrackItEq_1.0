...
public class gpsLocationListener {
    ...
    private boolean checkForProvider() {
        LocationManager lm = (LocationManager)me.getSystemService(Context.LOCATION_SERVICE);
        boolean gps_enabled = false;
        boolean network_enabled = false;
        boolean rtnAnswer = true;
        try {
        ...
        if(!gps_enabled && !network_enabled) {
            ...
            dialog.setMessage(me.getResources().getString(R.string.gps_network_not_enabled));
            dialog.setPositiveButton(me.getResources().getString(R.string.open_location_settings), new DialogInterface.OnClickListener() {
                @Override
            ...
            dialog.setNegativeButton(this.me.getString(R.string.Cancel), new DialogInterface.OnClickListener() {
